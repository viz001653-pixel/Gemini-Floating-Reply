...
1. 前往 [Releases](https://github.com/viz001653-pixel/gemini-floating-reply/releases/latest) 页面，下载 `gemini-floating-reply.zip` 并**解压**
...
1. Go to the [Releases](https://github.com/viz001653-pixel/gemini-floating-reply/releases/latest) page, download `gemini-floating-reply.zip`, and **extract** it
