...
1. 前往 [Releases](../../releases/latest) 页面，下载 `gemini-floating-reply.zip` 并**解压**
...
1. Go to the [Releases](../../releases/latest) page, download `gemini-floating-reply.zip`, and **extract** it
